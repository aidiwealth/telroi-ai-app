...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    costSttPerSec: process.env.COST_STT_PER_SEC || '',
    costLlmInPerTok: process.env.COST_LLM_IN_PER_TOK || '',
    costLlmOutPerTok: process.env.COST_LLM_OUT_PER_TOK || '',
    costTtsPerChar: process.env.COST_TTS_PER_CHAR || '',

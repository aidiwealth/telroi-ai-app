...
const items = [
  ...
  { label: 'Support teams', to: '/admin/teams', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="8" cy="8" r="3"/><circle cx="17" cy="9" r="2.5" opacity="0.75"/><path d="M2.5 19a5.5 5.5 0 0 1 11 0"/><path d="M15 19a4 4 0 0 1 6.5-3.1" opacity="0.75"/></svg>' },

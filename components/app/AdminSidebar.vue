...
const items = [
  ...
  { label: 'Webhook log', to: '/admin/webhook-log', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3a4 4 0 0 1 3.5 5.9l2.6 4.4"/><path d="M8 21a4 4 0 0 1-2-7.4l2.6-4.4" opacity="0.75"/><path d="M18 21a4 4 0 0 0 0-8h-5"/><circle cx="12" cy="7" r="1.4"/></svg>' },
  { label: 'SIP requests', to: '/admin/sip-requests', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="6" rx="1.5"/><rect x="3" y="14" width="18" height="5" rx="1.5" opacity="0.7"/><path d="M6.5 8h.01M6.5 16.5h.01"/></svg>' },
  ...
  { label: 'AI Usage', to: '/admin/ai-usage', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15l3-4 3 3 4-6"/></svg>' },
  { label: 'SIP Status', to: '/admin/sip-status', icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12.5a10 10 0 0 1 14 0"/><path d="M8 15.5a6 6 0 0 1 8 0"/><circle cx="12" cy="18.5" r="1"/></svg>' },
  { label: 'Carriers', to: '/admin/carriers', superadminOnly: true, icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7h16M4 12h16M4 17h10"/><circle cx="18" cy="17" r="2.2"/></svg>' },
  ...
  { label: 'PBX logs', to: '/admin/pbx-logs', superadminOnly: true, icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="14" rx="2"/><path d="M7 8l3 3-3 3M13 14h4"/></svg>' },
